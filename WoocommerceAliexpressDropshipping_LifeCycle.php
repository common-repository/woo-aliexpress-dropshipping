...
class WoocommerceAliexpressDropshipping_LifeCycle extends WoocommerceAliexpressDropshipping_InstallIndicator
{
    ...
    protected function addSettingsSubMenuPageToPluginsMenu()
    {
        ...
        add_submenu_page(
            $parentSlug, // Use the parent slug
            'Temu Import', // Replace with your submenu title
            'Temu Import', // Replace with your submenu title
            'manage_options', // Capability required to access the submenu
            'temu-slug', // Replace with your submenu slug
            array(&$this, 'submenuTemuCallback') // Callback function for the submenu page
        );


        add_submenu_page(
            $parentSlug, // Use the parent slug
            'Amazon Import', // Replace with your submenu title
            'Amazon Import', // Replace with your submenu title
            'manage_options', // Capability required to access the submenu
            'Amazon-slug', // Replace with your submenu slug
            array(&$this, 'submenuAmazonCallback') // Callback function for the submenu page
        );
    ...
    function my_plugin_go_pro_page_callback()
    {
        ...
        <div class="wrap">
            ...
            <a style="margin-top: 20px;" href="https://sharkdropship.com/wooshark-dropshipping/" target="_blank"
                class="button button-primary">Upgrade Now</a>
        </div>
        <style>
            .feature-cards {
                display: flex;
    ...
    public function submenuAmazonCallback()
    {
        echo '<p style="color: #513434; padding: 61px; font-size: 2rem; background-color: #eee9e9; border-radius: 10px; margin: 20px; }"> please install the chrome extension from here <a target=”_blank” href="https://chromewebstore.google.com/detail/sharkd-for-temualiexpress/ajbncoijgeclkangiahiphilnolbdmmh">  Here is the link to the extension</a></p> 
        <iframe width="560" height="315" src="https://www.youtube.com/embed/1pZ8fH7A8Qw?si=23bt-pfa0tO2XSY7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';

    }
    public function submenuTemuCallback()
    {
        echo 
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/jicCfB9hvXo?si=0XGHRh4JOI15bHkf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
    }
